...
PORT=$port nodeunit duration.js epur.js password.js init.js list.js user.js garbage.js movie.js release.js link.js search.js config.js permission.js || ret=1
kill %1
